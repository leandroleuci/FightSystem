...
namespace Fight.Tablero.Clases
{
    public class Fight
    {
        ...
        public int FaltaCombatienteAzul(bool suma)
        {
            if (suma)
            {
        ...
        public int FaltaCombatienteRojo(bool suma)
        {
        ...
        public void ResultadoFinal(ref bool rojo, ref bool azul, ref bool empate)
        {
            ...
            if (combatienteAzul.puntaje > combatienteRojo.puntaje)
                azul = true;
