...
/// <summary>
/// Enumeración que contiene los eventos para registrar en la Auditoría
/// </summary>
public enum enumEventosAuditoria
{
    InicioAuditoria,
    InicioRound,
    FinRound,
    ...
    QuitarFaltaRojo,
    MediaFaltaRojo,
    QuitarMediaFaltaRojo,
    FaltaAzul,
    QuitarFaltaAzul,
    MediaFaltaAzul,
    QuitarMediaFaltaAzul,
    VotacionManualRojo,
    QuitarVotacionManualRojo,
    VotacionManualAzul,
    QuitarVotacionManualAzul,
    PararPelea,
    Pausa,
    ContinuarPelea
}
